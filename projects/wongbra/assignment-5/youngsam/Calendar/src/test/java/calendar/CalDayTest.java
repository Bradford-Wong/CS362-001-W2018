...
//		 
	 ...
	 @Test
	  public void test05()  throws Throwable  {
		 ...
		 assertNotEquals(	"\t1/15/2018 at 8:30pm ,Birthday Party, This is my birthday party.\n", calday.getAppts().getFirst().toString()); //should be equal
		 ...
		 assertNotEquals(5, calday.getSizeAppts());
		 ...
		 assertNotEquals(6, calday.getSizeAppts());
		 assertNotEquals(	"\t1/15/2018 at 10:30am ,Birthday Party, This is my birthday party.\n", calday.getAppts().getFirst().toString());
		 assertNotEquals(null, calday.iterator()); //all of the assert statements above should be equal
	 }
